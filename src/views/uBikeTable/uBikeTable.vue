...
<template>
  <div class="app">
    <p>
      站點名稱搜尋: <search v-model:searchText="searchText"></search>
    </p>
    <uBikeTable :data="slicedUbikeStops" v-model:currentSort="currentSort" 
    v-model:isSortDesc="isSortDesc" :searchText="searchText"></uBikeTable>
    
  </div>

  <pagination :pagerEnd="pagerEnd" v-model:currentPage="currentPage" :pagerAddAmount="pagerAddAmount" :totalPageCount="totalPageCount"></pagination>
</template>
